...
from snspd_measure.lib.instruments.general.vsense import VSense, StandInVSense
from snspd_measure.lib.instruments.general.vsource import VSource, StandInVSource
...
@dataclass
class IVCurveResources(BaseModel):
